# Generated by Powerlevel10k configuration wizard on 2020-02-05 at 10:53 CST.
...
# vertical separators, round heads, flat tails, 2 lines, disconnected, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT="%D{\uF017 %H:%M \uF073 %Y.%m.%d}"
